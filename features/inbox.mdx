---
title: "Inbox"
description: "Notification-style feed for completed and cancelled tasks"
icon: "inbox"
---
...
|--------|------|-------------|
| `GET` | `/api/inbox` | List all inbox items (done or cancelled, non-archived) with labels, team, and project |

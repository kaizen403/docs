...
Please note that each CLI release is tied to a specific version of Mintlify. If your local preview doesn't match production, update the CLI:
...
Curious about what changed in the latest version? Check out the [CLI changelog](https://www.npmjs.com/package/mintlify?activeTab=versions).

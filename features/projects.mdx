---
title: "Projects"
description: "Higher-level initiatives that group tasks and span across teams"
icon: "folder-open"
---
...
| `teamIds` | yes | array of team IDs (exactly 1) | — |
| `repoUrl` | no | GitHub URL | null |
| `localPath` | no | local filesystem path | null |

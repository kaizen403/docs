---
title: "God Mode"
description: "Floating quick-access overlay for triggering Brainstorm from anywhere in the app"
icon: "bolt"
---
...
5. The [Brainstorm](/features/brainstorm) panel picks up the event and generates tasks

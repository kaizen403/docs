...
Design a docs site that matches your brand.
...
<Columns cols={2}>
  ...
  >
    Organize your docs so users can find what they need.
  </Card>
  <Card
...
Tools for writing and styling your docs pages.
...
>
  Browse documentation sites built with Mintlify.
</Card>

...
description: "Run a single task through an AI agent — clone, branch, code, commit, PR"
icon: "play"
---
...
After execution completes, the system generates a brief outcome summary stored on the task:
